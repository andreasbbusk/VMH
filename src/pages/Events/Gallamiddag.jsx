...
const Gallamiddag = () => {
    ...
    const GallaSlider = () => {
      const images = [GallaImage1, GallaImage2, GallaImage3, GallaImage4, GallaImage5];
        ...
        <div className={styles['galla-program-slider']}>
          {images.map((image, index) => (
            <img
              ...
              className={`${styles['galla-slider-image']} ${currentImageIndex === index ? styles.active : ''}`}
            />
          ))}
          ...
          <div className={styles['galla-slider-dots']}>
            {images.map((_, index) => (
              <div
                key={index}
                className={`${styles['galla-slider-dot']} ${currentImageIndex === index ? styles.activeDot : ''}`}
        ...
        <div className={styles['intro-container']}>
          <div className={styles['image-container']}>
            ...
            <div className={styles['overlay']}>
              ...
              <button className={styles['overlay-button']}>Resevér plads</button>
            </div>
          </div>
  
          <div className={styles['intro-tekst']}>
            <h1> <bold>Gallamiddag</bold> <br />Kampen mod hudcancer <br />gennem lokale midler</h1>
            <hr className={styles['intro-divider']} />
            <p>
              Som en del af Vejle, inviteres du til at deltage i vores Gallaaften. Her kan du byde på auktionen med masser af eksklusive gaver <br /> <br />
              Hele arrangementet er sponsoreret, så entré og auktionsprovenue går ubeskåret til kampen mod hudcancer. Lokalt forankrede virksomheder stiller med ekspertise/udstyr/faciliteter u/b.
            </p>
            <button className={styles['intro-button']}>Se sponsorer</button>
          </div>
        </div>
        ...
        <div className={styles['galla-program-container']}>
          <div className={styles['galla-program-tekst']}>
            ...
            <p className={styles['galla-program-lille-tekst']}>
              <p>Der fotograferes i løbet af aftenen. Billederne kan blive brugt <br />
              til markedsføring af Vejle mod hudcancer. </p>
            </p>
          </div>
...
<p>Alle midler der indsamles går ubeskåret til årets projekt, så vær med til at give en <br />
 gave til alle i Vejle. En gave, der kan give mange vejlensere et bedre liv, gennem <br />
 en hurtigere, meget mindre smertefuld og mere tryg behandling af hudcancer. <br />
<bold> Så lad os kæmpe sammen</bold> og lave et brag af en indsamling - så vi kan hjælpe flest <br />
...
<div className={styles.Gallacard}>
      <img src={Munkebjerg} alt="Card image" className={styles.GallacardImageTop} />
      ...
      <div className={styles.GallacardBottom}>
        <img src={Munkebjerg} alt="Bottom image" className={styles.GallacardImageBottom} />
        <div className={styles.GallacardPrice}>Værdi: 5.593 kr.</div>
      </div>
    </div>

    <div className={styles.Gallacard}>
      <img src={Kollagen} alt="Card image" className={styles.GallacardImageTop} />
      ...
      <div className={styles.GallacardBottom}>
        <img src={Nutrinic} alt="Bottom image" className={styles.GallacardImageBottom} />
        <div className={styles.GallacardPrice}>Værdi: 3.588 kr.</div>
      </div>
    </div>

    <div className={styles.Gallacard2}>
      <img src={JellingIMG} alt="Card image" className={styles.GallacardImageTop2} />
      ...
      <div className={styles.GallacardBottom2}>
        <img src={JellingTekst} alt="Bottom image" className={styles.GallacardImageBottom2} />
...
<p>Ønsker du at bidrage med en gave til støttegalla 2025, <br /> 
er du meget velkommmen til at kontakte os på nedestående link</p>
      </div>
