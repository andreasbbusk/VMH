    ...
    <>
      ...
      <div className={styles["torveevent-intro-container"]}>
        <div className={styles["torveevent-intro-venstre"]}>
          <div className={styles["torveevent-venstre-tekst"]}>
            <h1>
              {" "}
              <bold>"Knast, sår & plet - Dag"</bold> <br />
              på rådhustorvet i vejle
            </h1>
            <hr className={styles["torve-divider"]} />
            <p>
              Knast, sår og plet dag 2024, blev afholdt lørdag den 20. april. Vi
              er i gang <br />
              med planlægning af en dato i foråret 2025.
            </p>
            <p>
              {" "}
              <bold>Dato vil blive opdateret her og på</bold>{" "}
              <a href="">Facebook.</a>
            </p>
          </div>
              ...
              {images.map((_, index) => (
                <span
                  ...
                  className={`${styles["dot"]} ${
                    index === currentImageIndex ? styles["active-dot"] : ""
                  }`}
      ...
      <div className={styles["torveknap-container"]}>
        <div className={styles["torveknaper"]}>
          <Link to="/sponsorer" className={styles["torve-alle-sponsor"]}>
            Alle Sponsorer
          </Link>
        </div>
        <div className={styles["torveknaper"]}>
          <Link to="/kontakt" className={styles["torve-bliv-sponsor"]}>
            Bliv Sponsor
          </Link>
        </div>
      </div>
