...
<div className={styles['forside-gallamiddag-billeder-container']}>
<div className={styles['forside-gallamiddag-billeder-venstre']}>
<img src={ForsideGallaVenstreEt} alt="" />
<img src={ForsideGallaVenstreTo} alt="" />
</div>
<div className={styles['forside-gallamiddag-billeder-hojre']}>
<img src={ForsideGallaHojreEt} alt="" />
<img src={ForsideGallaHojreTo} alt="" />
</div>
</div>
<div className={styles['forside-gallamiddag-tekst-container']}>
<div className={styles['forside-gallamiddag-tekst']}>
<h1>GALLAMIDDAG <br />
2025</h1>
<p>Som en del af Vejle, inviteres du til at deltage i vores Gallaaften. <br />
Her kan du byde på auktionen med masser af eksklusive gaver. <br />
<br /> <br />
Hele arrangementet er sponsoreret, så entré og auktionsprovenue går <br />
ubeskåret til kampen mod hudcancer.  <br />
Lokalt forankrede virksomheder stiller med ekspertise/udstyr/faciliteter u/b.</p>
</div>

<div className={styles['Forside-knap-container']}>
<div className={styles['Forside-knaper']}>
    <button className={styles['ForsideResever']}>Reservér plads</button>
    </div>
    <div className={styles['Forside-knaper']}>
    <button className={styles['Forsidelasmereknap']}>Læs mere her</button>
    </div>
        </div>
...
<div className={styles['Forside-projekt-container']}>
  <p>Projekt 25</p>
</div>
...
<div className={styles['Forside-knast-container']}>
  ...
  <img src={KnastBilledeVenstre} alt="" />
      ...
      <div className={styles['Forside-knast-tekst']}>
        <h1>“KNAST, SÅR & PLET” - DAG </h1>
        <p>Få din hud tjekket af læger i teltet på torvet - Det er helt gratis og uforpligtende
   <br /> Ny dato for 2025 på vej</p>
          <div className={styles['Forside-knast-knap-container']}>
              <div className={styles['KnastPil']}>
                <img src={KnastPil} alt="" />
                </div>
                <div className={styles['KnastKnap']}>
                <button className={styles['KnastLæsmereKnap']}>Læs mere her</button>
                </div>
          </div>
      </div>
  <div className={styles['Forside-knast-billede-hojre']}>
...
<div className={styles['FraIdeTilIndsats-venstre']}>
  <h1>Fra idé til indsats</h1>
  <hr className={styles["FraIdeTilIndsats-divider"]} />
  <p>Vejle mod Hudcancer er et lokalt initiativ dedikeret til at bekæmpe
    <br /> hudkræft gennem oplysning, forebyggelse og tidlig diagnosticering. Med
    <br /> udgangspunkt i Vejle Sygehus’ ekspertise og et stærkt samarbejde med
    <br /> sundhedsorganisationer og lokalsamfundet arbejder vi for at reducere
    <br /> antallet af hudkræfttilfælde. <br />
Vi fokuserer på at oplyse om solbeskyttelse, risikofaktorer og vigtigheden
<br /> af regelmæssige hudtjek. Samtidig tilbyder vi konkrete events som gratis 
<br />hudscreeninger og en støtte-galla fest, hvor det er muligt at byde på 
<br />auktioner, hvor det samlede beløb går ubeskåret til årets projekter.

<br /> <br />Sammen kan vi gøre en forskel og sikre, at færre rammes af denne alvorlige
<br /> sygdom – for en sundere fremtid i Vejle og resten af Danmark. Din støtte
<br /> kan hjælpe os med at nå endnu længere!</p>
<div className={styles['Forside-knap-container']}>
<div className={styles['Forside-knaper']}>
    <button className={styles['FraIdeTilIndsatsStotNu']}>Støt nu</button>
    </div>
    <div className={styles['Forside-knaper']}>
    <button className={styles['FraIdeTilIndsatsLasMere']}>Læs mere</button>
    </div>
        </div>
  </div>
  <div className={styles['FraIdeTilIndsats-hojre']}>
  <img src={IdeTilIndsats} alt="" />
  <p>F.v. Christina Omann Clemmensen. Dorthe Maglehøj. 
  <br />Birgitte Busk. Susanne Skovbjerg. </p>
</div>
  </div>
</div>
