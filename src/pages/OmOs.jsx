...
<p>Is simply dummy text of the printing and typesetting industry. <br />
 Lorem Ipsum has been the industrys standard dummy text ever <br />
  ...
  scrambled it to make a type specimen book. It has survived not <br />
...
<h1> <bold>Ideen bag</bold> <br /> 
Vejle mod hudcancer</h1>
...
<p> <bold>med din støtte</bold> <br />
kan vi samle ind til <br />
kampen mod hudcancer</p>
</div>
</div>
<div className={styles['VMV-sammen']}>
<img src={VMVSammen} alt="" />
<div className={styles['VMV-stotte-tekst']}>
<p> <bold>Sammen kan</bold> <br />
vi opnå store <br />
Resultater</p>
</div>
</div>
...
<div className={styles['VMV-stotte-tekst']}>
<p> <bold>gennem lokale</bold> <br />
midler kan vi gavne <br />
kræftcenteret i vejle</p>
</div>
</div>
</div>
...
<div className={styles['omos-kontakt-tekst']}>
    ...
    <p>Du er velkommen til at kontakte os og finde ud af hvordan du <br />
    kan være med i kampen mod hudcancer</p>
